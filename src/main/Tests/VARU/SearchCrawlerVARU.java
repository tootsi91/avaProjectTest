...
public class SearchCrawlerVARU extends JFrame {
        ...
        Thread thread = new Thread(new Runnable() {
            public void run() {
                ...
                if (table.getRowCount() == 0) {
                    JOptionPane.showMessageDialog(SearchCrawlerVARU.this,
...
/* Check if search string is present in page, and if so, record a match. *//*
    ...
    public static void main(String[] args) {
        SearchCrawlerVARU crawler = new SearchCrawlerVARU();
        crawler.show();
    }
}
